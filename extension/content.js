...
function setScanButtonIcon(button, isOpen) {
  button.innerHTML = isOpen ? EYE_OPEN_SVG : EYE_CLOSED_SVG;
  button.dataset.scanned = isOpen ? "true" : "false";
  button.setAttribute(
    "aria-label",
    isOpen ? "Image scanned — click to rescan" : "Scan image for deepfakes",
  );
}
...
function createScanButton(imageElement) {
  ...
  setScanButtonIcon(button, false);
